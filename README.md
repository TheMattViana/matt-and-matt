...
| Game | What it is |
| --- | --- |
| 🎨 **Doodle Drift** | A draw-and-guess *telephone* game. A random prompt kicks off two chains, and each turn you **guess the doodle** you just received and **draw the word** you got — then text it on. The meaning drifts a little every hop, so by the end "a cat on a skateboard" has become "angry pancake." **No winners, no losers** — the payoff is the end screen replaying both chains side by side. Both of you draw and guess every round. |
