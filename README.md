...
| 🐧 **Icebreaker** | Slide-and-shove sumo on an ice floe. Tap a direction and your penguin **slides until it hits an ice block, the edge, or your rival**. Slide *into* your rival and you shove them **one cell** — so you have to **corner them at the very edge** and shove them off into the water to win. A slow, deliberate positioning duel. Every board is procedurally generated and guaranteed winnable. |
