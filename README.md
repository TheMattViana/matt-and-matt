...
| 🐧 **Icebreaker** | Turn-based sumo on an ice floe. Each turn you step **one square** in any direction; step into your rival to **shove them one square**. Ice blocks and the board edge are your tools — **corner your rival against the edge and shove them off** into the water to win. A slow, deliberate positioning duel. Every board is procedurally generated and guaranteed winnable. |
