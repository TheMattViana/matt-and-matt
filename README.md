...
| 🐧 **Icebreaker** | Turn-based sumo on breaking ice. Each turn you step **one square** — and **every square you step off of cracks**. You can't step onto cracked ice (you'd fall), but **shove your rival onto a crack or off the edge** and they plunge through. Get boxed in by cracks with no safe step and you go under too. The floe falls apart as you play, so a game always ends with a winner. |
