...
| 🐧 **Icebreaker** | Slide-and-shove sumo on an ice floe. Tap a direction and your penguin **slides until it hits an ice block, the edge, or your rival**. Slide *into* your rival and you shove them the same way — knock them off the floe into the water to win. Every board is procedurally generated and guaranteed winnable. |
